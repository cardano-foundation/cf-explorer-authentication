...
/**
 * Transform the aws ses secret key into an SMTP password Docs:
 * https://docs.aws.amazon.com/ses/latest/dg/smtp-credentials.html Java Code gist:
 * https://gist.github.com/sysadmiral/c85c09e6534428a8bb578ab420a40207
 */
@Component
public class SesSmtpCredentialGenerator {

  private static final String MESSAGE =
      "SendRawEmail"; // Used to generate the HMAC signature. Do not modify.
