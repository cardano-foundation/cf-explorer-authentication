...
public class VerifyMailController {
  ...
  public ResponseEntity<MessageResponse> checkVerifySignUpByEmail(
      @Parameter(name = "code", description = "Account activation code", required = true)
          @Valid
          @RequestParam("code")
          String code) {
  ...
  public ResponseEntity<MessageResponse> resetPassword(
    ...
    return ResponseEntity.ok(verifyService.forgotPassword(email, httpServletRequest));
  }
  ...
  public ResponseEntity<MessageResponse> newPassword(
    ...
    return ResponseEntity.ok(verifyService.resetPassword(resetPasswordRequest));
  }
  ...
  public ResponseEntity<Boolean> checkExpiredCode(
      @Parameter(name = "code", description = "Account verify code", required = true)
          @Valid
          @RequestParam("code")
          String code) {
