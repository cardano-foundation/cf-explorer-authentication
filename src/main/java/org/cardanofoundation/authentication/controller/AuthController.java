...
public class AuthController {
  ...
  public ResponseEntity<MessageResponse> signUp(
      @Valid @RequestBody SignUpRequest signUpRequest, HttpServletRequest httpServletRequest) {
  ...
  public ResponseEntity<RefreshTokenResponse> refreshToken(
      @Parameter(
              ...
              required = true)
          @Valid
          @RequestParam("refreshJwt")
          String refreshJwt,
      HttpServletRequest httpServletRequest) {
    return ResponseEntity.ok(authenticationService.refreshToken(refreshJwt, httpServletRequest));
  }
  ...
  public ResponseEntity<MessageResponse> signOut(
      @Valid @RequestBody SignOutRequest signOutRequest, HttpServletRequest httpServletRequest) {
  ...
  public ResponseEntity<NonceResponse> findNonceByAddress(
      @Parameter(
          ...
          @PrefixedValid(CommonConstant.PREFIXED_ADDRESS)
          String address,
      @Parameter(
              name = "walletName",
